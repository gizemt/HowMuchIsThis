...
def main_sgd():
    ...
    fitlog = sgd_network.model.fit(x_train, y_train, shuffle = True, batch_size = 512, nb_epoch=25)
   ...
   # plt.figure(figsize=(5, 5n))
    ...
    print 'Min error', np.min(abs(y_rand - y_test))*scale, 'Min idx = ', np.argmin(y_rand - y_test) 
